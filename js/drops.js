...
var drops = {
	areas:[
		...
		locations:[
			...
			website: "www.mcfaddenssandiego.com"
			},
			{
			...
			incentive: "",
			website: "www.bigbrickstraining.com"
			}
		]
		},
		{
		...
		locations: [
			...
			website: "www.livingwaterrejuvenation.com/sandiego"
			},
			{
			name: "Hollywood Tans",
			...
			},
{
		...
		locations: [
			...
			incentive:"",
			website: "www.cavallomotorsports.com"
			}
		]
		}
	].sort(
...
function locationDetails(area, location) {
